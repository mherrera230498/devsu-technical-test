...
![alt text](https://github.com/mherrera230498/devsu-technical-test/blob/master/readme_imgs/diagram.png?raw=true)
...
![alt text](https://github.com/mherrera230498/devsu-technical-test/blob/master/readme_imgs/github-action-workflow.png?raw=true)
...
To delete all resources deployed with helm run:

```bash
helm ls -a --all-namespaces | awk 'NR > 1 { print  "-n "$2, $1}' | xargs -L1 helm uninstall
```
